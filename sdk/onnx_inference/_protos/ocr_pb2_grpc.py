...
class OCRServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recognize = channel.unary_unary(
                ...
                request_serializer=ocr__pb2.RecognizeRequest.SerializeToString,
                response_deserializer=ocr__pb2.RecognizeResponse.FromString,
...
def add_OCRServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Recognize': grpc.unary_unary_rpc_method_handler(
                    servicer.Recognize,
                    request_deserializer=ocr__pb2.RecognizeRequest.FromString,
                    response_serializer=ocr__pb2.RecognizeResponse.SerializeToString,
            ),
    }
...
class OCRService(object):
    ...
    def Recognize(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ocr.OCRService/Recognize',
            ocr__pb2.RecognizeRequest.SerializeToString,
            ocr__pb2.RecognizeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
